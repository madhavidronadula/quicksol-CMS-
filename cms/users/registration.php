...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
	<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff;font-family:georgia,garamond,serif;font-style:bold;font-size:30px;">QUICK SOL</a></h3>
	<hr />
...
echo htmlentities($msg);
    ...
    <script>
        $.backstretch("assets/img/login-bg.jpg", {speed: 700});
    </script>
